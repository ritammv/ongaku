...
const ShowDetails: React.FC = () => {
  ...
  //   thumb:
  //     'https://img.discogs.com/nMq7oGtPld1JM6DwVDZQmJBSTIw=/fit-in/150x150/filters:strip_icc():format(jpeg):mode_rgb():quality(40)/discogs-images/R-768729-1300115438.jpeg.jpg',
  //   cover_image:
  //     'https://img.discogs.com/A5d0DW0UJrSkkqraPIxUm5B8zNU=/fit-in/598x600/filters:strip_icc():format(jpeg):mode_rgb():quality(90)/discogs-images/R-768729-1300115438.jpeg.jpg',
